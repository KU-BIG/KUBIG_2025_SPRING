...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--totalIter', type=int, default=20_0000, help='Total number of training iterations')
        parser.add_argument('--displayStep', type=int, default=100, help='display info every N iteration')
        parser.add_argument('--valStep', type=int, default=200, help='validate every N iteration') #2000
        ...
        parser.add_argument('--valServer',type=str,default='none',help="When in validate server mode, sets the bind addr. Otherwise, set the addr of the validating server. ")
        parser.add_argument('--gradientStep', type=int, default=250, help='Write gradients into tensorboard every N iteration')
